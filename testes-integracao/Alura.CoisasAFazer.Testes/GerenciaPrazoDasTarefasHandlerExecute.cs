    ...
    public class GerenciaPrazoDasTarefasHandlerExecute
    {
        ...
        public void QuandoTarefasEstiveremAtrasadasDevemMudarSeuStatus()
        {
            ...
            var tarefas = new List<Tarefa>
            {
                ...
                new Tarefa(100, "Tirar o lixo", casaCateg, new DateTime(2018,12,31), null, StatusTarefa.Criada),
                ...
                new Tarefa(102, "Arrumar a cama", casaCateg, new DateTime(2019,5,5), null, StatusTarefa.Criada),
                new Tarefa(103, "Escovar os dentes", higiCateg, new DateTime(2019,1,2), null, StatusTarefa.Criada),
                new Tarefa(105, "Comprar presente para o João", compCateg, new DateTime(2019,10,8), null, StatusTarefa.Criada),
        ...
        [Fact]
        public void QuandoInvocadoDeveChamarAtualizarTarefasNaQtdDeVezesDoTotalDeTarefasAtrasadas()
        {
            //arrange 
            ...
            {
                //atrasadas a partir de 1/1/2019
                new Tarefa(100, "Tirar o lixo", categ, new DateTime(2018,12,31), null, StatusTarefa.Criada),
